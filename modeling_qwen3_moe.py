    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if self.iteration < 50:
            ...
            available_k = [8, 12]
            top_k = available_k[(self.iteration-50)%len(available_k)]
        elif self.iteration < 150:
            available_k = [8, 12, 16]
            top_k = available_k[(self.iteration-100)%len(available_k)]
        else:
            available_k = [8, 12, 16, 20]
            top_k = available_k[(self.iteration-150)%len(available_k)]
        self.iteration += 1
