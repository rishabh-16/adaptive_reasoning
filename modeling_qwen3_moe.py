...
# /home/rishabhtiwari/.conda/envs/01_training/lib/python3.12/site-packages/transformers/models/qwen3_moe/modeling_qwen3_moe.py
...
class Qwen3MoeSparseMoeBlock(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor, top_k: Optional[int] = None) -> torch.Tensor:
        """ """
        ...
        # print(f"routing_weights: {routing_weights.shape}, selected_experts: {selected_experts.shape}")
...
class Qwen3MoeDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        hidden_states = self.mlp(hidden_states, top_k)
...
class Qwen3MoeModel(Qwen3MoePreTrainedModel):
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        if top_k == 0:
            available_k = [4, 8, 16]
            top_k = random.choice(available_k)
        # print(f"top_k: {top_k}")
