...
CHECKPOINT_NUMBER_VALUES=(6000)
MAX_TOKENS_PER_CALL_VALUES=(32000)
THINKING_BUDGET_VALUES=(0 4096 8192 16384)
# THINKING_BUDGET_VALUES=(0)
...
echo "Running SLURM_ARRAY_TASK_ID=$SLURM_ARRAY_TASK_ID with top_k=$TOP_K and checkpoint=$CHECKPOINT_NUMBER and max_tokens_per_call=$MAX_TOKENS_PER_CALL and thinking_budget=$THINKING_BUDGET"
...
DATA_NAME="aime24"
OUTPUT_DIR="/home/rishabhtiwari/repos/01_META_REASONING_MOE/experiments/04_evaluation/outputs/checkpoint${CHECKPOINT_NUMBER}_max_tokens_per_call${MAX_TOKENS_PER_CALL}_thinking_budget${THINKING_BUDGET}"
mkdir -p "${OUTPUT_DIR}"
DIR_TO_CHECK="/home/rishabhtiwari/repos/01_META_REASONING_MOE/experiments/04_evaluation/outputs/checkpoint${CHECKPOINT_NUMBER}_max_tokens_per_call${MAX_TOKENS_PER_CALL}_thinking_budget${THINKING_BUDGET}/${DATA_NAME}/test_qwen25-math-cot_-1_seed0_t0.0_top_k${TOP_K}_enable_thinkingTrue_s0_e-1_qwen25-math-cot_metrics.json"
