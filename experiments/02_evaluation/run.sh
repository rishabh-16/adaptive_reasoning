...
TOP_K_VALUES=(1 2 4 8 12 16 20 24 28 32)
# TOP_K_VALUES=(20 24 28 32)
CHECKPOINT_NUMBER_VALUES=(100 500 1000)
...
DATA_NAME="math500"
OUTPUT_DIR="/home/rishabhtiwari/repos/01_META_REASONING_MOE/experiments/02_evaluation/outputs/checkpoint${CHECKPOINT_NUMBER}_max_tokens_per_call${MAX_TOKENS_PER_CALL}"
mkdir -p "${OUTPUT_DIR}"
